...
StigForge-exported Ansible role **`al2023_cis`** · release **`0.3.0`**.
...
```bash
ansible-galaxy role install stigready.al2023_cis,0.3.0
```
...
|---|---:|---:|---|---|---|
| `cis-l1` | **96.97%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260912T135819Z |
| `cis-l2` | **97.01%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260912T140019Z |
