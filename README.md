...
StigForge-exported Ansible role **`al2023_cis`** · release **`0.2.4`**.
...
```bash
ansible-galaxy role install stigready.al2023_cis,0.2.4
```
...
|---|---:|---:|---|---|---|
| `cis-l1` | **96.97%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260729T223619Z |
| `cis-l2` | **97.01%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260729T223847Z |
